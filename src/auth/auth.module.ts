  ...
  imports: [
    JwtModule.registerAsync({
      useFactory: (configService: ConfigService) => ({
        //registerAsync lets you inject ConfigService (env) at module initialization time, so JwtService gets the secret before it starts signing tokens. Without this, JwtService wouldn't know what secret to use
